 ...
 */
public class LegacyShiftType {

    public static final String TAG = LegacyShiftType.class.getSimpleName();

    // Core properties
    private final String name;             // LegacyShift name (e.g., "Morning")
    private final String description;      // Description (e.g., "Morning shift 6-14")
    private final LocalTime startTime;     // Start time
    private final Duration duration;       // LegacyShift duration
     ...
     */
    public LegacyShiftType(String name, String description, int startHour, int startMinute,
    ...
    /**
     * @return First char of LegacyShift name
     */
    ...
    /**
     * @return LegacyShift description
     */
    ...
    /**
     * @return LegacyShift duration in hours
     */
    ...
    /**
     * Add this method to your LegacyShiftType class
     */
    ...
    public boolean equals(Object obj) {
        ...
        LegacyShiftType other = (LegacyShiftType) obj;
