package net.calvuz.qdue.core.ui.di;
...
public class ComponentBackBuilder {
     ...
     */
    public void register(@NonNull net.calvuz.qdue.core.ui.interfaces.BackPressHandler handler) {
     ...
     */
    public void registerUnsavedChanges(@NonNull net.calvuz.qdue.core.ui.interfaces.UnsavedChangesHandler handler) {
     ...
     */
    public void registerSelectionMode(@NonNull net.calvuz.qdue.core.ui.interfaces.SelectionModeHandler handler) {
     ...
     */
    private static class EnhancedBackHandler implements net.calvuz.qdue.core.ui.interfaces.MultiLevelBackHandler {
        private final net.calvuz.qdue.core.ui.interfaces.BackPressHandler mHandler;
        private final int mPriority;
        private final String mDescription;

        EnhancedBackHandler(net.calvuz.qdue.core.ui.interfaces.BackPressHandler handler, int priority, String description) {
    ...
    private static class EnhancedUnsavedChangesHandler extends EnhancedBackHandler
            implements net.calvuz.qdue.core.ui.interfaces.UnsavedChangesHandler {
        private final net.calvuz.qdue.core.ui.interfaces.UnsavedChangesHandler mUnsavedHandler;

        EnhancedUnsavedChangesHandler(net.calvuz.qdue.core.ui.interfaces.UnsavedChangesHandler handler,
