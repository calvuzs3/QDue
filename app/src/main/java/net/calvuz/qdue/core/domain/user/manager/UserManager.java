package net.calvuz.qdue.core.domain.user.manager;

import android.content.Context;

import net.calvuz.qdue.core.domain.user.data.entities.User;
import net.calvuz.qdue.core.domain.user.data.models.GoogleAuthData;
import net.calvuz.qdue.core.domain.user.data.models.UserWithOrganization;
import net.calvuz.qdue.core.domain.user.data.repository.UserRepository;
import net.calvuz.qdue.core.domain.user.data.repository.OrganizationRepository;
import net.calvuz.qdue.core.domain.user.services.GoogleAuthService;
