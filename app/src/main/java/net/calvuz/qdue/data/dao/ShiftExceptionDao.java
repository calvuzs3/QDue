...
public interface ShiftExceptionDao {
    ...
    @Query ("DELETE FROM shift_exceptions")
    int deleteAllShiftExceptions();
    ...
    @NonNull
    List<ShiftExceptionEntity> getShiftExceptionsByUserId(@NonNull String userId);

    @Query ("SELECT * FROM shift_exceptions WHERE user_id = :userId AND target_date = :date AND active = 1 ORDER BY priority DESC")
    @NonNull
    List<ShiftExceptionEntity> getShiftExceptionsForUserAndDate(@NonNull String userId, @NonNull String date);
    ...
    @NonNull
    List<ShiftExceptionEntity> getShiftExceptionsForUserInDateRange(@NonNull String userId, @NonNull String startDate, @NonNull String endDate);

    @Query ("SELECT * FROM shift_exceptions WHERE user_id = :userId AND status = :status AND active = 1 ORDER BY target_date DESC")
    @NonNull
    List<ShiftExceptionEntity> getShiftExceptionsByUserAndStatus(@NonNull String userId, @NonNull String status);
    ...
    @NonNull
    List<ShiftExceptionEntity> getUserAbsences(@NonNull String userId);
    ...
    @NonNull
    List<ShiftExceptionEntity> getUserShiftChanges(@NonNull String userId);
    ...
    @NonNull
    List<ShiftExceptionEntity> getUserTimeReductions(@NonNull String userId);
    ...
    @NonNull
    List<ShiftExceptionEntity> getShiftSwapsInvolvingUser(@NonNull String userId);
    ...
    @NonNull
    List<ShiftExceptionEntity> getShiftSwapsBetweenUsers(@NonNull String userId1, @NonNull String userId2);

    @Query ("SELECT * FROM shift_exceptions WHERE replacement_user_id = :userId AND active = 1 ORDER BY target_date DESC")
    @NonNull
    List<ShiftExceptionEntity> getReplacementAssignmentsForUser(@NonNull String userId);
    ...
    @Query ("""
            ...
            """)
    @NonNull
    List<ShiftExceptionEntity> getEffectiveExceptionsForUserAndDate(@NonNull String userId, @NonNull String date);
    ...
    int getExceptionCountForUser(@NonNull String userId);
    ...
    @Query ("""
            ...
            """)
    @Nullable
    UserExceptionStatistics getUserExceptionStatistics(@NonNull String userId);
