...
public interface UserScheduleAssignmentDao {
    ...
    @Query("""
        ...
        """)
    @Nullable
    UserScheduleAssignmentEntity getActiveAssignmentForUserOnDate(@NonNull Long userId, @NonNull String date);
    ...
    @Query("""
        ...
        """)
    @NonNull
    List<UserScheduleAssignmentEntity> getAssignmentsForUserInDateRange(@NonNull Long userId, @NonNull String startDate, @NonNull String endDate);

    @Query("SELECT * FROM user_schedule_assignments WHERE user_id = :userId AND status = :status AND active = 1 ORDER BY start_date DESC")
    @NonNull
    List<UserScheduleAssignmentEntity> getAssignmentsByUserAndStatus(@NonNull Long userId, @NonNull String status);
    ...
    @Query("""
        ...
        """)
    @NonNull
    List<UserScheduleAssignmentEntity> findConflictingAssignments(@NonNull Long userId, @NonNull String startDate, @NonNull String endDate, @NonNull String excludeAssignmentId);
    ...
    @Query("""
        ...
        """)
    @NonNull
    List<UserScheduleAssignmentEntity> getActiveConflictingAssignments(@NonNull Long userId, @NonNull String startDate, @NonNull String endDate);
    ...
    """)
    @NonNull
    List<Long> getAllActiveUserIdsOnDate(@NonNull String date);
    ...
    int getAssignmentCountForUser(@NonNull Long userId);
