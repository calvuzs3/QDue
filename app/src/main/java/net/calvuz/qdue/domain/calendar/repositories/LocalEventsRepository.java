...
/**
 * LocalEvent Repository Interface
 *
 * <p>Provides comprehensive repository interface for LocalEvent data operations
 * following the repository pattern and clean architecture principles. This interface
 * defines all data access operations for LocalEvent entities with consistent
...
public interface LocalEventsRepository
{
    ...
    /**
     * Create new LocalEvent in repository.
     *
     * @param event LocalEvent to create (must not be null)
    ...
    /**
     * Update existing LocalEvent in repository.
     *
     * @param event LocalEvent to update (must have valid ID)
