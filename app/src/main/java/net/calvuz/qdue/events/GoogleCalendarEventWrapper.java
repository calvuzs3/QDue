 ...
 */
public class GoogleCalendarEventWrapper implements CalendarEvent {
    private final com.google.api.services.calendar.model.Event googleEvent;
    private final String calendarId;

    public GoogleCalendarEventWrapper(com.google.api.services.calendar.model.Event googleEvent,
                                      String calendarId) {
