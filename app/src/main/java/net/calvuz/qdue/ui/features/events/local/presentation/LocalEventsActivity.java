 ...
 */
public class LocalEventsActivity
        ...
        implements Injectable
{
    ...
    private void initializeViews() {
        mToolbar = findViewById(R.id.toolbar_local_events);
        mFabAddEvent = findViewById(R.id.fab_add_local_event);
        mLoadingStateView = findViewById(R.id.loading_state_local_events);
    }
    ...
    private void initializeDependencies() {
        ...
        mLocalEventsModule = mCalendarServiceProvider.getLocaEventsModule();
        //
           //      new LocalEventsModule(this, mCalendarServiceProvider);

//        if mLocalEventsModule.ser
        ...
        try {
            ...
            switch (destination) {
                case "event_detail":
                    ...
                    break;
                case "create_event":
//                    mNavController.navigate(R.id.action_events_list_to_create_event, args);
