...
DaysListAdapter adapter = new DaysListAdapter(context, items, team, legacyShifts);

// New DI-based instantiation
DaysListModule module = new DaysListModule(context, eventsService, userService);
DaysListAdapter adapter = module.provideDaysListAdapter(context, items, team, legacyShifts);
```
